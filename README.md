...
![alt METALoci](https://github.com/martirenom/METALoci/pictures/METALoci_logo.png)
...
This Python [Jupyter notebook](https://github.com/3DGenomes/METALoci/jupyter/sox9_e13.5.ipny) can be used as example on how to analyze the Sox9 locus from the mouse genome on its differential enhancer hubs during development in gonadal cells (that is, at E13.5 days during development).

Contributors
************

METALocoi is currently developed at the [MarciusLab](http://www.marciuslab.org>) with the contributions of Juan A. Rodríguez and coceptual input from Oscar Lao.
